    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stastus', models.CharField(choices=[('send', 'send'), ('read', 'read'), ('cancel', 'cancel'), ('delete', 'delete')], default='create', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Group_join',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_now', models.CharField(choices=[('Create', 'Create'), ('Cancel', 'Cancel'), ('Accept', 'Accept'), ('Complete', 'Complete')], default='create', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_grapql.item')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_sell', models.FloatField(default=0, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.FloatField(max_length=20)),
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app_grapql.items_seller')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Create', 'Create'), ('Cancel', 'Cancel'), ('Accept', 'Accept'), ('Complete', 'Complete')], default='create', max_length=50)),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_grapql.invoice')),
